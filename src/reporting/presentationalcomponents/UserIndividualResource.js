...
class UserIndividualResource extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isHide: true,
    ...
    render() {
        console.log("UserIndividualResource::props::", this.props)
        ...
        if (this.props.type && this.props.type == "test") {
            ...
            isDetails = test.session_date_time.length>0?true:false
            package_text = []
            ...
            <div>
                ...
                <span style={{marginLeft:"30px"}}>
                        <Link to={"/userDashboard/contest/" + this.props.userProfileId + "/" + test.id}
                            className="refier_custom_button_save" style={{padding:"10px 10px"}}>
                        Retake
                    </Link>
                </span>
            </div>
            ...
            if (content.number_of_full_view) {
                for (let i = 0; i < content.number_of_full_view.length; i++) {
                    if (content.number_of_full_view[i] != 0) {
                        number_of_full_views = number_of_full_views + content.number_of_full_view[i]
                    }
        ...
        return (
            <Grid fluid style={{ marginTop: "10px", padding:"0px"}}
                ...
                {/* <Col xs={4} md={3} style={{ padding: "0px" }}> */}
                ...
                <div className="custom-list-title-content" style={{margin:"5px", marginLeft:"10px"}}>
                        {activity_name}
                    </div>
                    <div className="custom-list-sub-content" style={{margin:"5px", marginLeft:"10px"}}>
                        {activity_status}
                    </div>
                {!isDetails ?
                    null:
...
export default connect(mapStateToProps)(UserIndividualResource);