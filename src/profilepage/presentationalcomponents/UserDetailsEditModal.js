        ...
        <FormGroup style={{"margin": "5px 0" }} controlId="basicDetails">
            <Row style={{"margin":"5px 20px"}}>
                ...
                <Col xs={9}>
                    ...
                    type="text" name="profileName"  defaultValue={profileName}/>
                </Col>
            </Row>
            ...
            <Row style={{"margin":"5px 20px"}}>
                ...
                <Col xs={9}>
                    ...
                    className="refier_text_on_light__3"
                    style={{ 'fontWeight': '600', "fontSize": "14px"}}
                    componentClass="select" placeholder="Select Gender" name="gender"  
                    defaultValue={gender||""}>
            ...
            <Row style={{"margin":"5px 20px"}}>
                ...
                <Col xs={9}>
                    ...
                    className="refier_text_on_light__3"
                    style={{ 'fontWeight': '600', "fontSize": "14px"}} 
                    type="date" name="dob" defaultValue={dob}/>
                </Col>
            </Row>
            ...
            <Row style={{"margin":"5px 20px" }}>
                ...
                <ButtonToolbar>
                    ...
                    style={{ "backgroundColor": "rgba(72, 82, 140, 1)", "margin":"5px 0px", 
                        "paddingLeft":"10px", "paddingRight":"10px"}} block
