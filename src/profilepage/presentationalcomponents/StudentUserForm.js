...
export default class StudentUserForm extends Component {
    constructor(props) {
        super(props);
    ...
    submitDetails(e) {
        ...
        profiledata.clsSec = this.state.discipline['value'].trim()
