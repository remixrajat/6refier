...
export default class AddMembersToGroup extends Component {
    constructor(props) {
        super(props);
    ...
    onAddClick() {
            this.props.onAddSelected(
                this.state.classesAndStudentsChecked, this.state.teachersChecked, "isMember")
    }
                ...
                <div>
                    ...
                    <Button
                        ...
                        onClick={this.props.onAddSelected.bind(this,
                            ...
                            this.state.teachersChecked,[],"isMember")}
                    >Add Members</Button>
