...
export default class AddOwnersToGroup extends Component {
    constructor(props) {
        super(props);
    ...
    onAddClick() {
            this.props.onAddSelected(this.state.classesAndStudentsChecked, this.state.teachersChecked, "isOwner")
    }
