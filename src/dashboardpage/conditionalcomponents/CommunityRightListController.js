...
import CommunityRightList from '../presentationalcomponents/CommunityRightList';


class CommunityRightListController extends Component {
    constructor(props) {
        super(props)
        this.state = {
            communitySearchText: ""
    ...
    return(
        <Col xs={12} style={style}>
            { header }
            <CommunityRightList communityDetails = {modifiedCommunityList}
                        ...
                        userId={this.props.userId} newUserForm={this.props.newUserForm ? this.props.newUserForm : false} />
        </Col>
    )
...
export default  connect(mapStateToProps)(CommunityRightListController);