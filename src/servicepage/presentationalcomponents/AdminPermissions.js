...
export default class AdminPermissions extends Component {
    ...
    render() {
        console.log("Admin Permissions : props : ", this.props, this.state)
        let self = this
            ...
            return (
                <div>
                    ...
                    <AddStudentsOrClasses communityTreeStructure={this.props.communityTreeStructure}
                        ...
                        title={"Select One or Group of "+this.props.communitylabels.students+ " as Experts"}
                        />
                        </div>
                    ...
                    <AddTeachers teacherStructure={this.props.teacherStructureState}
                        ...
                        communitylabels={this.props.communitylabels}
                            title={"Select One or Group of " + this.props.communitylabels.teachers + " as Experts"} />
                    </div>
                    <div style={{marginTop:"20px"}}>
                    {this.props.statusOfRequest == 2?
                        <Row>
                            <Col xs={12} style={{ "textAlign": "center" }}>
                                <Preloader loaderMessage="Setting Trainers..." />
                            </Col>
                        </Row>
                            :
                            this.props.statusOfRequest == -1?
                                            ...
                                            this.props.statusOfRequest == 1?
                                                <div className="form-status-success">
                                                 Experts Assigned. Please refresh the page.
                                            </div>
                                    :
                        <Row>
                            <Col xs={12} style={{ "textAlign": "center" }}>
                                <Button bsStyle="default" style={{ display: "block", margin: "0 auto" }}
                                    ...
                                    onClick={this.props.setAdminPermissionForCourse.bind(this,
