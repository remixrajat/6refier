        ...
        if (this.props.details.type !== "All"){
            if (this.props.companySkillToSubEntity) {
                ...
                if (entityTags.length === 0) {
                    tagsBody.push(<div style={{ fontWeight: '400', fontSize:"12px" }}>Click on <b>Add Skills</b> to add Skills</div>)
                } else {
    ...
    render() {
        ...
        for (var i = 0; i < this.props.details.children.length; i++) {
            ...
            if (this.props.details.children[i].type != "Student") {
                listItems.push(
                    <CommunitySkillMappingList {...this.props} details={this.props.details.children[i]} />
        ...
        return (
            <div>
                <CommunitySkillMapping listItems={listItems} {...this.props}
...
export default connect(mapStateToProps)(CommunitySkillMappingList);