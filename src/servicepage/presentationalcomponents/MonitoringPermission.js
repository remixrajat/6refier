...
export default class MonitoringPermission extends Component {
    constructor(props) {
        super(props);
                ...
                <div>
                    <div className="custom-item-border">
                        <AlreadyAddedMembers members={this.props.members}
                            title={"Assigned Monitoring Permission"}
                    ...
                    <AddStudentsOrClasses communityTreeStructure={this.props.communityTreeStructure}
                        ...
                        title={"Select One or Group of "+this.props.communitylabels.students+ " for Monitoring"}
                        />
                        </div>
                    ...
                    <AddTeachers teacherStructure={this.props.teacherStructureState}
                        ...
                        communitylabels={this.props.communitylabels}
                            title={"Select One or Group of " + this.props.communitylabels.teachers + " for Monitoring"} />
                    </div>
                    <div style={{marginTop:"20px"}}>
                        ...
                        <Row>
                            ...
                            this.props.statusOfRequest == -1?
                                            ...
                                            this.props.statusOfRequest == 1?
                                                ...
                                                Monitoring Permissions Assigned. Please refresh the Page.
                                            </div>
                                    :
                        <Row>
                            <Col xs={12} style={{ "textAlign": "center" }}>
                                <Button bsStyle="default" style={{ display: "block", margin: "0 auto" }}
                                    ...
                                    onClick={this.props.setMonitoringPermissionForCourse.bind(this,
                                        self.state.classesAndStudentsChecked, self.state.teachersChecked,
                                    self.props.nodeIdTypeObject)} 
                                >Set Monitoring Permissions</Button>
                            </Col>
                        </Row>
                        }
                        </div>
